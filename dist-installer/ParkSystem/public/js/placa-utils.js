/**
 * Utilidades de placa colombiana (carro / moto).
 * Carro: 3 letras + 3 dígitos (ABC123 / OMG650)
...
(function (root, factory) {
    ...
    const CIUDADES = [
        ...
        'NEIVA', 'ARMENIA', 'COLOMBIA', 'SANTA', 'MARTA'
    ];

    const LETTER_FIX = { '0': 'O', '1': 'I', '8': 'B', '5': 'S', '2': 'Z', '6': 'G' };
    const DIGIT_FIX = { 'O': '0', 'Q': '0', 'D': '0', 'I': '1', 'L': '1', 'Z': '2', 'S': '5', 'B': '8', 'G': '6' };
    // Solo estas suelen ser dígitos mal leídos al final (no letras reales de moto)
    ...
    function extraerPlacaDeTexto(texto) {
        ...
        // Placa exacta de 6 chars: si parece moto por O/I/S final, preferir carro corregido
        if (limpio.length === 6) {
